...
public class JoinUserController {
    ...
    ***************************************** */
    ...
    public ResponsemMessageDto confirmPassword(@PathVariable("password1") String password1,@PathVariable("password2") String password2){

         return validationService.confirmPassword(password1,password2);
    }
